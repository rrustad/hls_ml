...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Flakehouse%2Flakehouse-hls-readmission%2F05-Workflow-Orchestration%2F05-Workflow-Orchestration-patient-readmission&cid=local&uid=local">
...
# MAGIC
# MAGIC <a dbdemos-workflow-id="init-job" href="/#job/552960457787511">Click here to access your Workflow job</a>, it was setup when you installed your demo.
# MAGIC
