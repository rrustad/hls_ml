...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Flakehouse%2Flakehouse-hls-readmission%2F00-patient-readmission-introduction&cid=local&uid=local">
...
# MAGIC %md 
# MAGIC
# MAGIC Open the HLS patient readmission  <a dbdemos-pipeline-id="dlt-patient-readmission" href="#joblist/pipelines/24e5f58d-0a4f-4e01-aaa3-2a1c4f170997" target="_blank">Delta Live Table pipeline</a> or the [SQL notebook]($./01-Data-Ingestion/01.1-DLT-patient-readmission-SQL) *(python DLT notebook alternative coming soon).* <br>
...
# MAGIC %md 
# MAGIC
# MAGIC Open the [Clinical Data Analysis notebook]($./03-Data-Analysis-BI-Warehousing/03-Data-Analysis-BI-Warehousing-patient-readmission) to start building your cohorts or directly open the <a href="/sql/dashboards/d2ca1ced-0c8f-4373-96b6-c99dcd881833" target="_blank">Patient analysis dashboard</a>
