...
-- MAGIC
-- MAGIC <!-- do not remove -->
-- MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Flakehouse%2Flakehouse-hls-readmission%2F01-Data-Ingestion%2F01.1-DLT-patient-readmission-SQL&cid=local&uid=local">
...
-- MAGIC
-- MAGIC
-- MAGIC The DLT pipeline was started for you! Click to <a dbdemos-pipeline-id="dlt-patient-readmission" href="#joblist/pipelines/24e5f58d-0a4f-4e01-aaa3-2a1c4f170997" target="_blank">open your Pipeline</a> and review its execution.
...
-- MAGIC
-- MAGIC Open the <a dbdemos-pipeline-id="dlt-patient-readmission" href="#joblist/pipelines/24e5f58d-0a4f-4e01-aaa3-2a1c4f170997" target="_blank">OMOP data model Delta Live Table pipeline</a> and click on start to visualize your lineage and consume the new data incrementally!
